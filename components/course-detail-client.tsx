                          ...
                          {teacher.whatsapp && (
                            ...
                            >
                              <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 3 .97 4.29L2 22l6.29-.97C9.5 21.62 10.75 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.41 0-2.73-.35-3.88-.99l-.28-.15-2.89.44.44-2.89-.15-.28C3.35 14.73 3 13.41 3 12c0-4.97 4.03-9 9-9s9 4.03 9 9-4.03 9-9 9zm4.6-6.5c-.25-.12-1.48-.73-1.71-.81-.23-.09-.4-.14-.56.14-.16.28-.63.81-.77.97-.14.16-.29.18-.54.06-.25-.12-1.05-.39-2-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.44.12-.14.16-.25.25-.41.09-.16.05-.3-.02-.42-.07-.12-.56-1.35-.77-1.84-.2-.48-.41-.42-.56-.43h-.48c-.16 0-.42.06-.64.3-.22.25-.86.84-.86 2.05 0 1.21.89 2.38 1.01 2.54.12.16 1.73 2.64 4.2 3.7.59.25 1.05.4 1.41.51.59.18 1.13.15 1.56.1.48-.07 1.48-.6 1.69-1.19.21-.59.21-1.1.15-1.19-.07-.08-.23-.13-.48-.25z" fill="white"/>
                              </svg>
                            </a>
                          )}
                        </div>
