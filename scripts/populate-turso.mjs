...
async function seedData() {
  try {
    ...
    await client.execute(`
      ...
      ('diseno-3d', 'Diseño e Impresión 3D', 'Crea y materializa tus ideas', 'Curso completo de diseño e impresión 3D. Aprenderás a usar software de modelado, preparación de archivos y técnicas de impresión.', 'PRESENCIAL', 'ACTIVE', 'Tecnología', '$3.500/mes', '8 semanas', 'Lunes y Miércoles 18:00 - 20:00', 'Centro de Innovación, ITS Savio', 'Ing. Carlos Martínez', 'PRESENCIAL', 'diseno-3d', 'PRINCIPIANTE', 1),
      ('python-aplicaciones', 'Desarrollo de Aplicaciones con Python', 'Aprende programación desde cero', 'Programa integral de Python orientado a la creación de aplicaciones de escritorio y web.', 'PRESENCIAL', 'ACTIVE', 'Programación', '$3.000/mes', '12 semanas', 'Martes y Jueves 19:00 - 20:30', 'Aula de Informática, ITS Savio', 'Lic. Gabriel Muñoz', 'PRESENCIAL', 'python-aplicaciones', 'PRINCIPIANTE', 1),
      ('electronica-arduino', 'Electrónica y Arduino', 'Proyectos electrónicos prácticos', 'Iniciación en electrónica analógica, digital y microcontroladores Arduino.', 'PRESENCIAL', 'ACTIVE', 'Electrónica', '$2.800/mes', '10 semanas', 'Viernes 17:00 - 19:00', 'Laboratorio de Electrónica, ITS Savio', 'Ing. Roberto López', 'PRESENCIAL', 'electronica-arduino', 'PRINCIPIANTE', 1),
      ('diseno-grafico', 'Diseño Gráfico Digital', 'Adobe Creative Suite', 'Domina las herramientas profesionales de diseño gráfico. Photoshop, Illustrator e InDesign para proyectos reales.', 'PRESENCIAL', 'ACTIVE', 'Diseño', '$3.200/mes', '10 semanas', 'Lunes y Viernes 19:00 - 20:30', 'Sala de Diseño, ITS Savio', 'Lic. Ana Pérez', 'PRESENCIAL', 'diseno-grafico', 'PRINCIPIANTE', 0)
    `)
